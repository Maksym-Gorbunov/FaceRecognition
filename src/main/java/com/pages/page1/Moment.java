...
public class Moment implements Runnable {
  ...
  public Moment(JPanel videoPanel){
  ...
  public void qqq(JPanel videoPanel) {
...
//      cvInRangeS(imghsv,Rminc,Rmaxc,imgbin);
      ...
      while (runnable && ((contour1 != null) && (!contour1.isNull()))) {
      ...
      while (runnable && ((contour2 != null) && (!contour2.isNull()))) {
      ...
      cvCircle(img1, cvPoint(posX, posY), 5, cvScalar(0, 255, 0, 0), 20, 0, 0);

      BufferedImage buff = img1.getBufferedImage();
      videoPanel.getGraphics().drawImage(buff, 0, 0, Constants.VIDEO_WIDTH, Constants.VIDEO_HEIGHT, 0, 0,
